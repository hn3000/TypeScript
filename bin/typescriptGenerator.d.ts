...
declare module ts {
    ...
    function walkProgram(filenames: string[], nodeWalker: (context: WalkerContext, node: Node, after: boolean) => boolean): void;
}
...
declare module tsgen {
    ...
    function getNodeKind(n: ts.Node): string;
    function getJsDocComments(node: any, sourcefile: any): CommentRange[];
    function walkProgram(filenames: string[], nodeHandler: (context: any, node: any, after: boolean) => boolean): void;
    function walkProgramNodes(filenames: string[], nodeWalker: tsgen.INodeWalker): void;
}
declare var module: {
    exports: any;
